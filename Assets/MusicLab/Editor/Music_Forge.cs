...
namespace MusicForge
{
    public class Music_Forge
    {
        ...
        public static string ClipName { get { return _clipName; } }
        public static Texture2D ResImage { get { return _resImage; } }

        public static void CreateSong()
        {
            int m_columns = SongCreatorClass.SongDuration;
            int m_rows = 3;
            ...
            //WFC
            _clipName = SongCreatorClass.CurrenMood.name;
            ...
            wave_function_collapse.OverrideGridForMusic();
            wave_function_collapse.ForceRowColapse(1,false);
