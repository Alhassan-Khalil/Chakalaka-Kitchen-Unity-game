    ...
    public class WFC_I_Audio : WFC_Interpreter
    {
        ...
        public AudioClip Create_Audio_Track()
        {
            ...
            for (int row = 0; row < m_grid.GetLength(0); row++)
            {
                ...
                chanelArray[row] = ClipCombiner.Cocatenate(trackArray, SongCreatorClass.CurrentGenre.crossfadeAmount,true);
            ...
            chanelArray[0] = ClipCombiner.Mix(chanelArray[0], SongCreatorClass.CurrenMood.masterization[0], chanelArray[1], "temp");
            chanelArray[0] = ClipCombiner.Mix(chanelArray[0], SongCreatorClass.CurrenMood.masterization[1], chanelArray[2], "temp");
